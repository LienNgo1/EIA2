...
window.addEventListener("load", Schneegestöber);

function Schneegestöber(): void {
...
function drawSnowflakes(_x:number, _y: number, _radius: number, _startAngle: number, _endAngle: number, _color: string): void {
